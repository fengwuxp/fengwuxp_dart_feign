...
class ArticleActionFeignClient extends FeignProxyClient {
    ...
    ArticleActionFeignClient() : super() {
       main();
            ...
            Future<PageInfo<ArticleActionInfo>>  query(
  QueryArticleActionReq req,
             [UIOptions feignOptions]) {
               return this.delegateInvoke<PageInfo<ArticleActionInfo>>("query",
                   [req,],
                    feignOptions: feignOptions,
                        serializer: BuiltValueSerializable(
                            serializer: PageInfo.serializer,
                        specifiedType:FullType(PageInfo,[FullType(ArticleActionInfo)])
                        )
               );
            }
            ...
            Future<int>  create(
  AddArticleActionReq req,
             [UIOptions feignOptions]) {
               return this.delegateInvoke<int>("create",
                   [req,],
                    feignOptions: feignOptions,
               );
            }
               ...
               /// 4:返回值在java中的类型为：ArticleActionInfo
                @GetMapping(value:'/{id}',)
            Future<ArticleActionInfo>  detail(
                     @PathVariable()
                int id,
             [UIOptions feignOptions]) {
               return this.delegateInvoke<ArticleActionInfo>("detail",
                   [id,],
                    feignOptions: feignOptions,
                        serializer: BuiltValueSerializable(
            ...
            Future<void>  edit(
  EditArticleActionReq req,
             [UIOptions feignOptions]) {
               return this.delegateInvoke<void>("edit",
                   [req,],
                    feignOptions: feignOptions,
               );
            }

...
/// use Milliseconds serializer
class DateTimeMillisecondsSerializer implements PrimitiveSerializer<DateTime> {
  ...
  DateTime deserialize(Serializers serializers, Object serialized,
    ...
    return DateTime.fromMillisecondsSinceEpoch(microsecondsSinceEpoch, isUtc: true);
  }
}

...
class MultipartRequest extends BaseRequest {
  ...
  MultipartRequest({String method, Uri url, int timeout}) : super(method ?? HttpMethod.POST, url, timeout ?? -1);
  ...
  @override
  void addContentLength(int len) {
    throw UnsupportedError('Cannot add the contentLength property of '
        'multipart requests.');
  }
